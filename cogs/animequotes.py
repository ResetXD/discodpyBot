...
class Ping(commands.Cog):
    ...
    @commands.command(aliases = ['animequote'])
    async def quote(self, ctx:Context):
        ...
        embedVar.add_field(name = "character" , value = "{0}".format(b["character"]))
        embedVar.add_field(name = "character" , value = "{0}".format(b["quote"]))
  ...
  "A skilled commander seeks victory from the situation and does not demand it of his subordinates."
        ...
        embedVar = discord.Embed(title="the art of war",color = discord.Colour.dark_theme())
        embedVar.add_field(name = "quote" , value = "{0}".format(random.choice(a)))
        await ctx.channel.send(embed = embedVar)
        return
